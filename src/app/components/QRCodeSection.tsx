            ...
            <div className='flex flex-col gap-2 items-center p-4 w-full justify-center'>
                ...
                {uploadedImage && (
                    <div className='relative w-[200px] h-[200px] place-content-center place-items-center'>
                        <img className='w-full h-full object-fill rounded-xl cursor-pointer' src={uploadedImage} alt={t("qrCode.uploaded")} onClick={handleImageClick} />
                        <button className='absolute py-1 top-2 right-2 text-white bg-red-500 text-sm font-medium' onClick={handleDeleteImage} >
                            ✕
                        </button>
