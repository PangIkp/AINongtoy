            ...
            <section className='w-full flex flex-col sm:flex-row sm:justify-around my-6 gap-5 min-w-sm'>
                ...
                <div className='w-full sm:w-1/2 px-5 xl:w-1/3 leading-10'>
                    ...
                    <div className='flex gap-4 mt-4'>
                        <a href="#"><Image src="/Images/AINongtoy/Facebook.png" alt="Facebook logo" width={logo_size} height={logo_size} /><p className='hidden'>Facebook</p></a>
                        <a href="#"><Image src="/Images/AINongtoy/Instagram.png" alt="Instagram logo" width={logo_size} height={logo_size} /><p className='hidden'>Instagram</p></a>
                        <a href="#"><Image src="/Images/AINongtoy/Twitter.png" alt="Twitter logo" width={logo_size} height={logo_size} /><p className='hidden'>Twitter</p></a>
                    </div>
                </div>
            </section>

            <div className='bg-[#20255E] text-white  w-full h-[52] flex justify-center items-center'>
